...
_NODE_LABEL_EN = {
    ...
    "jet_fuel": "Jet Fuel Price",
    "heavy_fuel": "Heavy Fuel Price",
    "naphtha": "Naphtha Price",
    "fertilizer": "Fertilizer Feedstock Cost",
    "industrial_electricity": "Industrial Electricity Price",
    "aviation_cost": "Aviation Operating Cost",
    "shipping_cost": "Shipping Fuel Cost",
    "chemical_cost": "Chemical Feedstock Cost",
    "agri_cost": "Agricultural Production Cost",
    "manuf_cost": "Manufacturing Energy Cost",
    "inflation": "Inflation Expectation",
    "interest_rate": "Interest Rate Expectation",
    "aviation_profit": "Aviation Profitability",
    "shipping_profit": "Shipping Profitability",
    "chemical_profit": "Chemical Sector Profitability",
    "energy_revenue": "Energy Sector Revenue",
    "agri_profit": "Agriculture Profitability",
    "manuf_profit": "Manufacturing Profitability",
    "finance_risk": "Financial System Risk",
}
...
class GraphQuery:
    ...
    def get_node_label(self, node_id: str) -> str:
        ...
        """
        if node_id in _NODE_LABEL_EN:
            return _NODE_LABEL_EN[node_id]
